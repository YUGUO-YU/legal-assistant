...
const categories = [
  { label: '民事起诉', value: 'civil', icon: '&#9998;' },
  { label: '合同协议', value: 'contract', icon: '&#128203;' },
  { label: '婚姻家庭', value: 'marriage', icon: '&#128141;' },
  { label: '劳动纠纷', value: 'labor', icon: '&#128188;' },
  { label: '交通事故', value: 'traffic', icon: '&#128663;' },
...
const templateVariables = computed(() => {
  ...
  return selectedTemplate.value.variables.map((v: string) => {
    const labels: Record<string, { label: string; type: string; placeholder: string }> = {
      ...
      plaintiff_gender: { label: '原告性别', type: 'text', placeholder: '男/女' },
      plaintiff_ethnicity: { label: '原告民族', type: 'text', placeholder: '请输入民族' },
      plaintiff_birthdate: { label: '原告出生日期', type: 'text', placeholder: '如：1990年1月1日' },
      plaintiff_address: { label: '原告住址', type: 'text', placeholder: '请输入住址' },
      plaintiff_phone: { label: '原告电话', type: 'text', placeholder: '请输入联系电话' },
      defendant_name: { label: '被告姓名', type: 'text', placeholder: '请输入被告姓名' },
      defendant_gender: { label: '被告性别', type: 'text', placeholder: '男/女' },
      defendant_address: { label: '被告住址', type: 'text', placeholder: '请输入住址' },
      claim: { label: '诉讼请求', type: 'textarea', placeholder: '请输入诉讼请求' },
      facts: { label: '事实与理由', type: 'textarea', placeholder: '请输入事实与理由' },
      court_name: { label: '法院名称', type: 'text', placeholder: '如：北京市朝阳区人民法院' },
      sign_date: { label: '签署日期', type: 'text', placeholder: '如：2024年6月7日' },
      contract_name: { label: '合同名称', type: 'text', placeholder: '请输入合同名称' },
      party_a: { label: '甲方', type: 'text', placeholder: '请输入甲方名称' },
      party_b: { label: '乙方', type: 'text', placeholder: '请输入乙方名称' },
      contract_amount: { label: '合同金额', type: 'text', placeholder: '请输入金额' },
      contract_start_date: { label: '合同开始日期', type: 'text', placeholder: '如：2024年1月1日' },
      contract_end_date: { label: '合同结束日期', type: 'text', placeholder: '如：2024年12月31日' }
    }
    return {
      name: v,
      ...(labels[v] || { label: v, type: 'text', placeholder: `请输入${v}` })
    }
  })
})
